...
var lakehouseRoomAliases = [
    { "name": "office_speakers", "alias": [ "office" ]},
    { "name": "porch_speakers", "alias": [ "porch" ]},
    { "name": "patio_speakers", "alias": [ "downstairs", "patio" ] },
    { "name": "bedroom_speakers", "alias": [ "bedroom" ] },
    { "name": "greatroom_speakers", "alias": [ "great room", "greatroom", "den", "living room", "livingroom", "upstairs" ] },
    { "name": "spa_speakers", "alias": [ "spa" ]},
    { "name": "dock_speakers", "alias": [ "dock" ]}];

/*
[{"name":"office_speakers","alias":["office"]},{"name":"porch_speakers","alias":["porch"]},{ "name":"patio_speakers","alias":["downstairs","patio"]},{ "name":"bedroom_speakers","alias":["bedroom"]},{ "name":"greatroom_speakers","alias":["great room","greatroom","den","living room","livingroom","upstairs"]},{"name":"spa_speakers","alias":["spa"]},{"name":"dock_speakers","alias":["dock"]}]
*/
